...
class FavoriteWorkPage extends StatefulWidget {
  const FavoriteWorkPage({super.key});

  @override
  State<FavoriteWorkPage> createState() => _FavoriteWorkPageState();
}

class _FavoriteWorkPageState extends State<FavoriteWorkPage> {
  List<dynamic> works = [];
  int totalItems = 0;
  int currentPage = 1;
  ...
  Future<void> fetchFavoriteCurrentPage() async {
    String resRecommend = await Request.getFavoriteWorks(currentPage);
